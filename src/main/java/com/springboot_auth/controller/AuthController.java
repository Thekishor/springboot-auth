...
import com.springboot_auth.dto.request.AuthRequest;
import com.springboot_auth.dto.request.ResetPasswordRequest;
import com.springboot_auth.dto.response.AuthResponse;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> userLogin(@Valid @RequestBody AuthRequest request) {
        try {
